...
Sistema de gestión de chats siguiendo el patrón de WhatsApp, permitiendo a los usuarios ocultar chats 1-to-1, salir de grupos y a los administradores eliminar grupos.
...
| **Leave** | ❌ Usar Hide | ✅ Todos | ❌ Auto-cerrado |
| **Delete** | ❌ Usar Hide | ✅ Admin/Creador | ❌ Solo admin/auto |

### Por Rol de Usuario

| Rol | Hide Chat | Show Chat | Leave Group | Delete Propio | Delete Cualquiera |
|-----|-----------|-----------|-------------|---------------|-------------------|
| **MEMBER** | ✅ | ✅ | ✅ | ❌ | ❌ |
| **TRAINER** | ✅ | ✅ | ✅ | ✅ | ❌ |
| **ADMIN** | ✅ | ✅ | ✅ | ✅ | ✅ |
...
### 4. Listar Chats Excluyendo Ocultos
...
| **Delete** | `channel.delete()` + `truncate()` | Update `status = CLOSED` |
...
- [Documentación de Stream Chat](https://getstream.io/chat/docs/)
- [Patrón WhatsApp](https://blog.whatsapp.com/)
