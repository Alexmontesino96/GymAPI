...
Proporciona operaciones de cache optimizadas para modelos Pydantic y listas,
con soporte de serialización, TTL, invalidación de patrones y profiling.
...
class AsyncCacheService:
    ...
    Funcionalidades:
    - get_or_set() - Cache genérico con fallback a BD
    - get_or_set_profiles_optimized() - Cache optimizado para perfiles
    - delete_pattern() - Invalidación por patrón
    - invalidate_user_caches() - Invalidación de cachés de usuarios
    - Serialización/deserialización con Pydantic
    - Soporte de orjson para mejor rendimiento
    - Profiling integrado con decoradores

    Permite cachear y recuperar modelos Pydantic o listas de modelos.

    Note:
        - YA estaba async en versión original
        - Renombrado para convención FASE 3
        - Usa redis.asyncio.Redis
    """
