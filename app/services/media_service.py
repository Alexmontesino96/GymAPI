"""
Servicio de media para manejar archivos de historias.
Extiende el StorageService existente para soportar media de historias.
"""
...
class MediaService(StorageService):
    """
    Servicio extendido para manejar media de historias (imágenes y videos).
    """
...
def get_media_service() -> MediaService:
    """
    Obtiene la instancia singleton del MediaService.
    """
