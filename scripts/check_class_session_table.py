#!/usr/bin/env python3
"""Quick check de la tabla class_session"""
import os
import sys
...
with engine.connect() as conn:
    ...
    print("Columnas de la tabla 'class_session':")
    print("-" * 60)
    for row in result:
    ...
    print("\nRegistro de ejemplo:")
    print("-" * 60)
    result = conn.execute(text("SELECT * FROM class_session LIMIT 1"))
